...
class FeedController {
  static createFeed = async (req, res, next) => {
    new CREATED({
      ...
      metadata: await FeedService.createFeed(
  ...
  static updateFeed = async (req, res, next) => {
    new OK({
      ...
      metadata: await FeedService.updateFeed(
        validationResult(req),
        req.user,
        req.params,
        req.body
  ...
  static getCertainFeed = async (req, res, next) => {
    new OK({
      ...
      metadata: await FeedService.getCertainFeed(
        req.user,
        req.params,
        req.query
      ),
  ...
  static reactFeed = async (req, res, next) => {
    new OK({
      ...
      metadata: await FeedService.reactFeed(
        validationResult(req),
        req.user,
        req.params,
        req.body
